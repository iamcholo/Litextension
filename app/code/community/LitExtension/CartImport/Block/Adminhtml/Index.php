...
class LitExtension_CartImport_Block_Adminhtml_Index
    extends Mage_Adminhtml_Block_Template{

    protected $_seo_plugin = array(
        'volusion' => array(
            'seo_volusion_default' => 'Default',
            'seo_volusion_custom' => 'Custom',
        ),
        'mivamerchant' => array(
            'seo_mivamerchant_default' => 'Default',
            'seo_mivamerchant_custom' => 'Custom',
        ),
        'yahoostore' => array(
            'seo_yahoostore_default' => 'Default',
        ),
        'nopcommerce' => array(
            'seo_nopcommerce_default' => 'Default',
        ),
        'squarespace' => array(
            'seo_squarespace_default' => 'Default',
        ),
    );
    ...
    protected function getCartsOption($value){
        $carts = Mage::getModel('lecaip/system_config_source_type')->toOptionArray();
    ...
    protected function getListUploadOfFirstCart(){
        $types = Mage::getModel('lecaip/system_config_source_type')->toOptionArray();
        $fc = "";
        if($types){
        ...
        $model = "lecaip/" . Mage::getModel('lecaip/cart')->getCart($fc);
        $cart = Mage::getModel($model);
        $upload = $cart->getListUpload();
        return $upload;
    }

    protected function getCartTypeFirst()
    {
        $types = Mage::getModel('lecaip/system_config_source_type')->toOptionArray();
        $fc = "";
        if($types){
    ...
    protected function createUploadId($name){

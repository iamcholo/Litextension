<?php
class LitExtension_Onestepcheckout_Helper_Country {
    ...
    {
        $this->filename = Mage::getBaseDir() . "/lib/MaxMind/GeoIP/data/" . Mage::getStoreConfig('onestepcheckout/geo/country_file');

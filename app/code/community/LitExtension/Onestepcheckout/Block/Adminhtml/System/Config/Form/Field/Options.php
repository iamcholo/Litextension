...
class LitExtension_Onestepcheckout_Block_Adminhtml_System_Config_Form_Field_Options extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    /**
     * @var LitExtension_Onestepcheckout_Block_Adminhtml_Form_Field_Options
     */
     ...
     *
     * @return LitExtension_Onestepcheckout_Block_Adminhtml_Form_Field_Options
     */
    protected function _getOptionRenderer()
    {
        if (!$this->_optionRenderer) {
            $this->_optionRenderer = $this->getLayout()->createBlock(
                'onestepcheckout/adminhtml_form_field_options'
            );
        }

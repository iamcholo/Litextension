...
class LitExtension_ACRegistration_Block_Adminhtml_Grid  extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        ...
        $this->setTemplate('le_acregistration/grid.phtml');
    }
    ...
    public function addNewButton(){
        return $this->getButtonHtml(
            Mage::helper('acregistration')->__('New Attribute'),

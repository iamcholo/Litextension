...
class LitExtension_ACRegistration_Block_Adminhtml_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_blockGroup = 'acregistration';
    ...
    public function getHeaderText()
    {
        ...
        if (Mage::registry('attributemanager_data')->getId()) {
            return Mage::helper('acregistration')->__('Edit %1$s Attribute "%2$s"', $type, $this->htmlEscape(Mage::registry('attributemanager_data')->getFrontendLabel()));
        } else {
            return Mage::helper('acregistration')->__('New %s Attribute', $type);
        }

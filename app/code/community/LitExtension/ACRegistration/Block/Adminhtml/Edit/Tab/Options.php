...
class LitExtension_ACRegistration_Block_Adminhtml_Edit_Tab_Options extends Mage_Adminhtml_Block_Widget
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('le_acregistration/options.phtml');
    }

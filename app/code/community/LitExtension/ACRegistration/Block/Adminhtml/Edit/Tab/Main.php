...
class LitExtension_ACRegistration_Block_Adminhtml_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('show_on_customer_grid', 'select', array(
            'name'  => 'show_on_customer_grid',
            'label' => Mage::helper('catalog')->__('Show on the Customer Grid'),
            'title' => Mage::helper('catalog')->__('Show on the Customer Grid'),
            'value'=> Mage::getModel('acregistration/acregistration')->getShowOnCustomerGrid($model->getId()),
            'values' => $yesno,
        ));
        ...
        $fieldset->addField('section', 'select', array(
            'name'  => 'section',
            'label' => Mage::helper('catalog')->__('Section on Registration'),
            'title' => Mage::helper('catalog')->__('Section on Registration'),
            'note' => Mage::helper('catalog')->__('Select section to show on registration frontend.'),
            'value'=> Mage::getModel('acregistration/acregistration')->getAcrId($model->getId()),
            'values'=>  array(
                array(
                    'value' => '0',
                    'label' => Mage::helper('catalog')->__('More Information')
                ),
                array(
                    'value' => '1',
                    'label' => Mage::helper('catalog')->__('Personal Information')
                ),
                array(
                    'value' => '2',
                    'label' => Mage::helper('catalog')->__('Login Information')
                ),
                array(
                    'value' => '3',
                    'label' => Mage::helper('catalog')->__('Address Information')
                ),
            )
        ));

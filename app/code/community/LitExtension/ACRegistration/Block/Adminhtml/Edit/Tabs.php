...
class LitExtension_ACRegistration_Block_Adminhtml_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab('main', array(
            ...
            'content'   => $this->getLayout()->createBlock('acregistration/adminhtml_edit_tab_main')->toHtml(),
            'active'    => true
        ));
        ...
        $this->addTab('labels', array(
            ...
            'content'   => $this->getLayout()->createBlock('acregistration/adminhtml_edit_tab_options')->toHtml(),
        ));

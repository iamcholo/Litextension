...
class LitExtension_ACRegistration_Block_Rewrite_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
    /**
     * Initialize block
     */
...
//            ->initDefaultValues();
        ...
        $attributes = $customerForm->getAttributesDefault();
...
//        }
    ...
    public function initCustomForm()
    {
        ...
        /** @var $customerForm Mage_Customer_Model_Form */
        $customerForm = Mage::getModel('acregistration/customer');
        $customerForm->setEntity($customer)
            ->setFormCode('adminhtml_customer')
            ->initDefaultValues();

        $fieldset = $form->addFieldset('base_fieldset', array(
            'legend' => Mage::helper('customer')->__('Custom Account Information')
        ));

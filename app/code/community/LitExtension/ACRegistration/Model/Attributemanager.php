...
class LitExtension_ACRegistration_Model_Attributemanager extends Mage_Eav_Model_Entity_Attribute
{
    ...
    protected function _initAcregistration(){
        ...
        if ($acrId) {
            $modelACR->load($acrId,'attribute_id');
        }

...
//            ),
        ...
        $fieldset->addField('show_on_customer_grid', 'select', array(
            ...
            'value'=> Mage::getModel('ajaxlogin/attributes')->getShowOnCustomerGrid($model->getId()),
            'values' => $yesno,
        ));
        ...
        $fieldset->addField('section', 'select', array(
            ...
            'value'=> Mage::getModel('ajaxlogin/attributes')->getAjaxloginId($model->getId()),
            'values'=>  array(
                array(
                    'value' => '0',
                ...
                array(
                    'value' => '1',
                    'label' => Mage::helper('catalog')->__('Profile Information')
                ),
                array(
                    'value' => '2',
